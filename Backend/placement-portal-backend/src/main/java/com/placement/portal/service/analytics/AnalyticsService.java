...
public class AnalyticsService {
     ...
     * @param highestPackage       maximum placement package across placed students (may be null)
    ...
    public DashboardStats getDashboardStats() {
        ...
        BigDecimal highestPackage = studentProfileRepository.findHighestPackageOfPlacedStudents();
